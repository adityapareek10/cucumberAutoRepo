...
public class MultipleScenarioStepDef {
	...
	public void user_enter_user_First_Name() throws InterruptedException {
	    driver.findElement(By.xpath("//input[@id='email']")).sendKeys("Aditya");
	...
	public void user_Checks_User_First_Name_is_present() throws InterruptedException  {
		...
		Assert.assertEquals("Aditya", actualUserName);
		Thread.sleep(2000);
	}

	@And("^User enters user surname$")
	public void user_enters_user_surname() throws InterruptedException {
	   driver.findElement(By.xpath("//input[@id='pass']")).sendKeys("challa");
	   Thread.sleep(2000);
	}
